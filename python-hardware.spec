...
%install
%{pyver_install}
# Do not package cardiff files from python-hardware-0.23
# to avoid needing X11 dependencies.
rm -rf %{buildroot}/%{pyver_sitelib}/hardware/cardiff || true
rm -f %{buildroot}/%{_bindir}/hardware-cardiff || true
...
%changelog
* Wed Jan 15 2020 Dmitry Tantsur <dtantsur@protonmail.com> 0.23.0-1
- Update to 0.23.0

* Wed Sep 25 2019 RDO <dev@lists.rdoproject.org> 0.21.1-1
- Update to 0.21.1
